...
{
  public partial class AllRequestReport : System.Web.UI.Page
  {
    ResourceManager rm;
    CultureInfo ci;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
      if (!Page.IsPostBack)
      {
        ...
        lnkAllReqReport.Attributes.Add("class", "nav-item menu-open");
        ...
        aAllReqReport.Attributes.Add("class", "nav-link active");
