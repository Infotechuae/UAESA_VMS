<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FileUpload.aspx.cs" Inherits="SecuLobbyVMS.FileUpload" %>
...
<body onload="fullScreen(document.documentElement)">
    <form autocomplete="off" id="form1" runat="server">
      ...
      <div id="test">
        <section class="content">
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <h5 class="card-header">
                                <asp:Label ID="header1" runat="server" Text="File Upload"></asp:Label>
                            </h5>
         ...
         <br /><br />
         <asp:Button ID="btnsave" runat="server" onclick="btnsave_Click" class="btn btn-success me-2 mb-4"  Text="Save" style="width:85px" />
         <br /><br />
       ...
       <asp:GridView ID="grdDetails" runat="server" AutoGenerateColumns="false" CssClass="table table-hover text-nowrap" GridLines="None" OnRowDeleting="grdDetails_RowDeleting">
              ...
              <asp:TemplateField>
                  <HeaderTemplate>
                      <asp:Label ID="lblh1" runat="server"  Text="ID"></asp:Label>
                  ...
                  <ItemTemplate>
                      <span><%# Eval("ID") %></span>
                              ...
                              <asp:TemplateField>
    <HeaderTemplate>
        <asp:Label ID="lblh2" runat="server"  Text="Document"></asp:Label>
    ...
    <ItemTemplate>
        <span><%# Eval("Name") %></span>
                              ...
                              <asp:TemplateField>
    <HeaderTemplate>
        <asp:Label ID="lblh2" runat="server"  Text="Uploaded On"></asp:Label>

    </HeaderTemplate>
    <ItemTemplate>
        <span><%# Eval("Date_Time") %></span>
    </ItemTemplate>
</asp:TemplateField>
              ...
              <asp:TemplateField HeaderText="Download">
               ...
               <asp:LinkButton ID="lnkDownload" runat="server" Text="Download" OnClick="DownloadFile"  
                  ...
                  <HeaderStyle CssClass="head" />
                                                    ...
                                                    <asp:TemplateField>
                                                       <HeaderTemplate>
                                                            <asp:Label ID="lblh8" runat="server"  Width="20px" Text="Delete"></asp:Label>
