...
{
  public partial class VisitRegistration : System.Web.UI.Page
  {
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
      if (!Page.IsPostBack)
      {
        ...
        lnkSelfReg.Attributes.Add("class", "nav-item menu-open");
        ...
        aSelfRegis.Attributes.Add("class", "nav-link active");
