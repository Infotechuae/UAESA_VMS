<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="subcheckin.aspx.cs" Inherits="SecuLobbyVMS.subcheckin" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <section class="content" id="divmain">
                                                ...
                                                <table style="width: 100%">
                                                    <tr>
                                                        ...
                                                        <td style="width: 50%; text-align: right;">
                                                            <asp:Button ID="btncheckOut" runat="server" Text="Check Out" class="btn btn-danger me-2 mb-4" OnClick="btncheckOut_Click" OnClientClick="mywaitdialog()" />
                                                            <%--  <asp:Button ID="btnWatchlist" runat="server" Text="Watchlist" class="btn btn-warning me-2 mb-4" data-toggle="modal" data-target="#modal-default" />--%>
                                ...
                                <div class="row">
                                    ...
                                    <div class="mb-3 col-md-4">
                                        ...
                                        <div class="input-group input-group-merge">
                                            ...
                                            <asp:TextBox ID="txtIDNumber" runat="server" class="form-control" OnTextChanged="txtIDNumber_TextChanged" AutoPostBack="true"></asp:TextBox>
                                        </div>
                                    </div>
                                    <div class="mb-3 col-md-4">
                                        <label for="drpDepartment" class="form-label">
                                    ...
                                    <div class="mb-3 col-md-4">
                                        ...
                                        <div class="input-group input-group-merge">
                                            ...
                                            <asp:TextBox ID="txtMobile" runat="server" onkeypress="return isNumberKey(event,this)" class="form-control"></asp:TextBox>
                                        </div>
                                    </div>
                                    <div class="mb-3 col-md-4">
                                    ...
                                    <div class="mb-3 col-md-4">
                                        <label for="drpNationality" class="form-label">
                                            <asp:Label ID="lblNationality" runat="server" class="form-label" Text="Nationality" Font-Bold="true"></asp:Label>
                                        </label>
                                        <%--<asp:DropDownList ID="drpNationality" runat="server" class="form-control select2" Style="width: 100%;">
                                        </asp:DropDownList>--%>
                                       <asp:TextBox ID="txtNationality" runat="server" class="form-control"></asp:TextBox>
                                    </div>
                                    <div class="mb-3 col-md-4">
                                        <label for="drpGender" class="form-label">
                                            <asp:Label ID="lblGender" runat="server" class="form-label" Text="Gender" Font-Bold="true"></asp:Label>
                                        </label>
                                        <asp:DropDownList ID="drpGender" runat="server" class="form-control select2" Style="width: 100%;">
                                            <asp:ListItem Text="Select" Value="Select"></asp:ListItem>
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="mb-3 col-md-4" style="display:none;">
                                        ...
                                        <asp:DropDownList ID="drpCompany" runat="server" class="form-control select2" Style="width: 100%;">
                                        </asp:DropDownList>
                                    </div>
                                    <div class="mb-3 col-md-4">
                                        <label for="drpDepartment" class="form-label">
                                    ...
                                    <div class="mb-3 col-md-4" style="display:none;">
                                        <label for="drpCard" class="form-label">
                                            <asp:Label ID="Label14" runat="server" class="form-label" ForeColor="#b68a35" Text="*" Font-Bold="true"></asp:Label>
                                        </label>
                                        <label for="drpCard" class="form-label">
                                            <asp:Label ID="Label13" runat="server" class="form-label" Text="Access Card" Font-Bold="true"></asp:Label>
                                        </label>

                                        <asp:DropDownList ID="drpCard" runat="server" class="form-control select2" Style="width: 100%;">
                                        </asp:DropDownList>
                                    </div>
                                   ...
                                   <div class="mb-3 col-md-4">
                                        <label for="drpPurpose" class="form-label">
                                ...
                                <div class="row">
                                    <div class="mb-3 col-md-12" style="text-align: right;">
                                        <asp:Button ID="btnCheckin" runat="server" Text="Check IN" class="btn btn-success me-2 mb-4" OnClick="btnCheckin_Click" OnClientClick="mywaitdialog()" />
