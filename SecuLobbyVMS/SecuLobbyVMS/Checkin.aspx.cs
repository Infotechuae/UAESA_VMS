  ...
  public partial class Checkin : System.Web.UI.Page
  {
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
      if (!Page.IsPostBack)
      {
        ...
        Session["selfid"] = null;
        string sselfID = "";
        sselfID = Convert.ToString(Request.QueryString["selfid"]);

        if (!string.IsNullOrEmpty(sselfID))
        {
          Session["selfid"] = sselfID;
        }
        ...
        lnkCheckin.Attributes.Add("class", "nav-item menu-open");
        ...
        aCheckIN.Attributes.Add("class", "nav-link active");
