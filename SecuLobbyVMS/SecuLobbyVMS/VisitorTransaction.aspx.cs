...
{
  public partial class VisitorTransaction : System.Web.UI.Page
  {
    ResourceManager rm;
    CultureInfo ci;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
      if (!Page.IsPostBack)
      {
        ...
        lnkVisTran.Attributes.Add("class", "nav-item menu-open");
        ...
        aVisTrans.Attributes.Add("class", "nav-link active");
