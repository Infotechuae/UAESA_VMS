  ...
  public partial class UserRole : System.Web.UI.Page
  {
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
      if (!Page.IsPostBack)
      {
        ...
        header1.Text = rm.GetString("STRN_6", ci);
    ...
    protected void btnAdd_Click(object sender, EventArgs e)
    {
      ...
      Response.Redirect("RoleBasedmenu.aspx");
    }
    public void gridbind()
    {
     
      string sSql = "select ID,UsertypeName from UserBasedMenu";
      if (txtSearch.Text != "")
      {
        sSql += " where (ID like '%" + txtSearch.Text.Trim() + "%' or UsertypeName like '%" + txtSearch.Text.Trim() +"%')";
      }
