<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SubAllRequestReport.aspx.cs" Inherits="SecuLobbyVMS.SubAllRequestReport" EnableEventValidation="false" %>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card">
                            <h5 class="card-header">
                                <asp:Label ID="header1" runat="server" Visible="false" Text="All Request Report"></asp:Label>
                               <asp:Label ID="Label1" runat="server" Text="All Request Report"></asp:Label>
                            </h5>
                            <!-- Account -->
                                    ...
                                    <div class="card-body table-responsive p-0">
                                        <asp:GridView ID="grdDetails" runat="server" AutoGenerateColumns="false" CssClass="table table-hover text-nowrap" GridLines="None">
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField>
                                                        <HeaderTemplate>
                                                            <asp:Label ID="lblh1" runat="server" Font-Size="Small" Text="Visitor Name"></asp:Label>
                                                    ...
                                                    <asp:TemplateField>
                                                        <HeaderTemplate>
                                                            <asp:Label ID="lblh2" runat="server" Font-Size="Small" Text="Visitor ID"></asp:Label>
                                                    ...
                                                    <asp:TemplateField>
                                                        <HeaderTemplate>
                                                            <asp:Label ID="lblh3" runat="server" Font-Size="Small"  Text="Mobile"></asp:Label>
                                                    ...
                                                    <asp:TemplateField>
                                                        <HeaderTemplate>
                                                            <asp:Label ID="lblh4" runat="server" Font-Size="Small" Text="Email ID"></asp:Label>
                                                    ...
                                                    <asp:TemplateField>
                                                        <HeaderTemplate>
                                                            <asp:Label ID="lblh5" runat="server" Font-Size="Small" Text="Company"></asp:Label>
                                                    ...
                                                    <asp:TemplateField>
                                                        <HeaderTemplate>
                                                            <asp:Label ID="lblh13" runat="server" Font-Size="Small" Width="20px" Text="Department"></asp:Label>
                                                    ...
                                                    <asp:TemplateField>
                                                        <HeaderTemplate>
                                                            <asp:Label ID="lblh14" runat="server" Font-Size="Small"  Text="Visitor Type"></asp:Label>
                                                    ...
                                                    <asp:TemplateField>
                                                        <HeaderTemplate>
                                                            <asp:Label ID="lblh24" runat="server" Font-Size="Small"  Text="Purpose"></asp:Label>
                                                    ...
                                                    <asp:TemplateField>
                                                        <HeaderTemplate>
                                                            <asp:Label ID="lblh7" runat="server" Font-Size="Small"  Text="Host"></asp:Label>
                                                    ...
                                                    <asp:TemplateField>
                                                        <HeaderTemplate>
                                                            <asp:Label ID="lblh8" runat="server" Font-Size="Small"  Text="Date"></asp:Label>
                                                    ...
                                                    <asp:TemplateField>
                                                        <HeaderTemplate>
                                                            <asp:Label ID="lblh9" runat="server" Font-Size="Small"  Text="Duration"></asp:Label>
                                                    ...
                                                    <asp:TemplateField>
                                                        <HeaderTemplate>
                                                            <asp:Label ID="lblh15" runat="server" Font-Size="Small"  Text="Status"></asp:Label>
