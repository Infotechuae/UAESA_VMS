<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SubWatchlist.aspx.cs" Inherits="SecuLobbyVMS.SubWatchlist" %>
                            ...
                            <div class="card-body" style="padding-bottom: 0px!important; padding-top: 10px!important; padding-left: 30px!important;">
                                <div class="d-flex align-items-start align-items-sm-center gap-4">
                                    <div class="button-wrapper" style="width: 100%; height: 50px;">
                                        <asp:Button ID="btncheckOut" runat="server" Text="Remove from Watchlist" class="btn btn-danger me-2 mb-4" OnClick="btncheckOut_Click" CausesValidation="false" />
                                    </div>
                                </div>
                            </div>
                            <hr class="my-0" />
                                    ...
                                    <div class="card-body table-responsive p-0">
                                        <asp:GridView ID="grdVisDetails" runat="server" AutoGenerateColumns="false" CssClass="table table-hover text-nowrap" GridLines="None">
                                            <Columns>
                                                ...
                                                <asp:TemplateField>
                                                    <HeaderTemplate>
                                                        <asp:Label ID="lblh6" runat="server" Font-Size="Small" Text="Department"></asp:Label>
                                                ...
                                                <asp:TemplateField>
                                                    <HeaderTemplate>
                                                        <asp:Label ID="lblh7" runat="server" Font-Size="Small"  Text='<%# GetHeader("Visitor Type") %>'></asp:Label>
                                                ...
                                                <asp:TemplateField>
                                                    <HeaderTemplate>
                                                        <asp:Label ID="lblh9" runat="server" Font-Size="Small"  Text="Purpose"></asp:Label>
                                                ...
                                                <asp:TemplateField>
                                                    <HeaderTemplate>
                                                        <asp:Label ID="lblh10" runat="server" Font-Size="Small"  Text='<%# GetHeader("Check In") %>'></asp:Label>
                                                ...
                                                <asp:TemplateField Visible="false">
                                                    <HeaderTemplate>
                                                        <asp:Label ID="lblh11" runat="server" Font-Size="Small" Text='<%# GetHeader("Duration") %>'></asp:Label>
