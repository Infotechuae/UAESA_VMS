<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="subVisitorInvite.aspx.cs" Inherits="SecuLobbyVMS.subVisitorInvite" %>
...
<body>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="mb-3 col-md-4">
                                        <label for="txtDepartment" class="form-label">
                                            <asp:Label ID="lblDepartment" runat="server" Visible="false" class="form-label" Text="Department" Font-Bold="true"></asp:Label>
                                            <asp:Label ID="lblDepartment1" runat="server" class="form-label" Text="Department" Font-Bold="true"></asp:Label>
                                        </label>
                                     ...
                                     <%--  added host,location by swati in sept24--%>
                                  <div class="mb-3 col-md-4">
  <label for="txtDepartment" class="form-label">
  ...
  <asp:DropDownList ID="drpHost" runat="server" class="form-control select2" Style="width: 100%;">
       ...
       <div class="mb-3 col-md-4">
    <label for="drpLoc" class="form-label">
       <asp:Label ID="lblLocation" runat="server" Visible="false" class="form-label" Text="Location" Font-Bold="true"></asp:Label>

        <asp:Label ID="lblLocation1" runat="server" class="form-label" Text="Location" Font-Bold="true"></asp:Label>
    </label>
    ...
    <asp:DropDownList ID="drpLocation" runat="server" class="form-control select2" Style="width: 100%;">
                                     ...
                                     <div class="mb-3 col-md-4" style="display:none;">
                                        <label for="txtLocation" class="form-label">
                                            <asp:Label ID="Label2" runat="server" class="form-label" Text="Floor" Font-Bold="true"></asp:Label>
                                        </label>
                        ...
                        <div class="card">
                            <h5 class="card-header">
                                <asp:Label ID="Label1" runat="server" Text="Visitor Information"></asp:Label></h5>
                            <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="mb-3 col-md-12">
                                        <div class="card-body table-responsive p-0">
                                            <asp:GridView ID="grdVisDetails" runat="server" AutoGenerateColumns="false" CssClass="table table-hover text-nowrap" GridLines="None" ShowFooter="true">
                                                <Columns>

                                                    <asp:TemplateField>
                                                        <HeaderTemplate>
                                                            <label for="txtVisName" class="form-label">
                                                                <asp:Label ID="lblVisName" runat="server" class="form-label" Text='<%# GetHeader("Visitor Name") %>' Font-Bold="true"></asp:Label>
                                                            </label>
                                                        </HeaderTemplate>
                                                        <ItemTemplate>
                                                            <asp:TextBox ID="txtVisName" runat="server" class="form-control" Text='<%#Eval("VisName") %>'></asp:TextBox>
                                                        </ItemTemplate>
                                                        <FooterTemplate>
                                                            <asp:TextBox ID="txtVisNameF" runat="server" class="form-control"></asp:TextBox>
                                                        </FooterTemplate>
                                                    ...
                                                    <asp:TemplateField>
                                                        <HeaderTemplate>
                                                            <label for="txtIDNumber" class="form-label">
                                                                <asp:Label ID="lblIDNumber" runat="server" class="form-label" Text='<%# GetHeader("ID Number") %>' Font-Bold="true"></asp:Label>
                                                            </label>
                                                        </HeaderTemplate>
                                                        <ItemTemplate>
                                                            <div class="input-group input-group-merge">
                                                        ...
                                                        <FooterTemplate>
                                                            <div class="input-group input-group-merge">
                                                                <asp:DropDownList ID="drpIDTypeF" runat="server" class="form-control select2" Width="150px">
                                                                    <asp:ListItem Text="Select" Value="Select"></asp:ListItem>
                                                                    <asp:ListItem Text="Emirates ID" Value="Emirates ID"></asp:ListItem>
                                                                    <asp:ListItem Text="Passport" Value="Passport"></asp:ListItem>
                                                                    <asp:ListItem Text="Others" Value="Others"></asp:ListItem>
                                                                </asp:DropDownList>
                                                                <asp:TextBox ID="txtIDNumberF" runat="server" class="form-control"></asp:TextBox>
                                                            </div>
                                                        </FooterTemplate>
                                                    ...
                                                    <asp:TemplateField>
                                                        <HeaderTemplate>
                                                            <label for="txtVisEmail" class="form-label">
                                                                <asp:Label ID="lblVisEmail" runat="server" class="form-label" Text='<%# GetHeader("Email") %>' Font-Bold="true"></asp:Label>
                                                            </label>
                                                        </HeaderTemplate>
                                                        <ItemTemplate>
                                                            <div class="input-group input-group-merge">
                                                                <span class="input-group-text"><i class="fas fa-envelope"></i></span>
                                                                <asp:TextBox ID="txtVisEmail" runat="server" class="form-control" TextMode="Email" Text='<%#Eval("VisEmail") %>'></asp:TextBox>
                                                            </div>
                                                        </ItemTemplate>
                                                        <FooterTemplate>
                                                            <div class="input-group input-group-merge">
                                                                <span class="input-group-text"><i class="fas fa-envelope"></i></span>
                                                                <asp:TextBox ID="txtVisEmailF" runat="server" class="form-control" TextMode="Email"></asp:TextBox>
                                                            </div>
                                                        </FooterTemplate>
                                                    ...
                                                    <asp:TemplateField>
                                                        <HeaderTemplate>
                                                            <label for="txtVisMobile" class="form-label">
                                                                <asp:Label ID="lblVisMobile" runat="server" class="form-label" Text='<%# GetHeader("Mobile Number") %>' Font-Bold="true"></asp:Label>
                                                            </label>
                                                        </HeaderTemplate>
                                                        <ItemTemplate>
                                                            <div class="input-group input-group-merge">
                                                                <span class="input-group-text"><i class="fas fa-phone"></i></span>
                                                                <asp:TextBox ID="txtVisMobile" runat="server" class="form-control" TextMode="Phone" Text='<%#Eval("VisMobile") %>'></asp:TextBox>
                                                            </div>
                                                        </ItemTemplate>
                                                        <FooterTemplate>
                                                            <div class="input-group input-group-merge">
                                                                <span class="input-group-text"><i class="fas fa-phone"></i></span>
                                                                <asp:TextBox ID="txtVisMobileF" runat="server" class="form-control" TextMode="Phone"></asp:TextBox>
                                                            </div>
                                                        </FooterTemplate>
                                                    ...
                                                    <asp:TemplateField>
                                                        <HeaderTemplate>
                                                            <label for="txtVisCompany" class="form-label">
                                                                <asp:Label ID="lblVisCompany" runat="server" class="form-label" Text='<%# GetHeader("Company") %>' Font-Bold="true"></asp:Label>
                                                            </label>
                                                        </HeaderTemplate>
                                                        <ItemTemplate>
                                                            <asp:TextBox ID="txtVisCompany" runat="server" class="form-control" Text='<%#Eval("Company") %>'></asp:TextBox>
                                                        </ItemTemplate>
                                                        <FooterTemplate>
                                                            <asp:TextBox ID="txtVisCompanyF" runat="server" class="form-control"></asp:TextBox>
                                                        </FooterTemplate>
                                                    ...
                                                    <asp:TemplateField>
                                                        ...
                                                        <ItemTemplate>
                                                            <asp:ImageButton ID="btndel" runat="server" CausesValidation="false"
                                                                ImageUrl="~/dist/img/jstaclkcancel.png" OnClick="btndel_Click" />

                                                        </ItemTemplate>
                                                        <FooterTemplate>
                                                            <asp:ImageButton ID="btndd" runat="server" CausesValidation="false"
                                                                ImageUrl="~/dist/img/smallplus.png" OnClick="btndd_Click" />
                                    ...
                                    <table style="width: 100%">
                                        <tr>
                                            ...
                                            <td style="width: 50%; text-align: right;">
                                                <asp:Button ID="btnInvite" runat="server" Text="Send Invite" class="btn btn-primary me-2 mb-4" OnClick="btnInvite_Click" OnClientClick="mywaitdialog()" />
